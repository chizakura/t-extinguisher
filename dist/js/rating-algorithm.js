...
var A = 0.8;
    var B = 0.9;
    var arr133 = [8, 10, 9, 5, 4, 6, 4, 7, 7, 8, 4, 10, 3, 5, 3, 8, 5, 9, 4, 5];
    var arr720 = [6, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
    const reducer = (accumulator, currentValue) => accumulator + currentValue;
    var sum = arr720.reduce(reducer,0);
    var avg = sum / arr720.length;
    var z = 1 - Math.pow(Math.E,-1);
